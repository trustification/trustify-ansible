...
|Option|Description|Type|Default|
|---|---|---|---|
| tpa_single_node_trustification_image | Trustification image. | str |  `registry.redhat.io/rhtpa/rhtpa-trustification-service-rhel9:764b0bf413261903e3521c173fedc07f1d44c36b`  |
...
| tpa_single_node_storage_endpoint | Read from 'TPA_STORAGE_MINIO_ENDPOINT' env var | str |  |
| tpa_single_node_storage_secret | storage.yaml path on the target machine | str |  `/etc/rhtpa/manifests/storage-secret.yaml`  |
| tpa_single_node_oidc_secret | oidc.yaml path on the target machine | str |  `/etc/rhtpa/manifests/Secrets/oidc.yaml`  |
| tpa_single_node_oidc_server_secret | secret.yaml path on the target machine | str |  `/etc/rhtpa/manifests/Secrets/server.yaml`  |
